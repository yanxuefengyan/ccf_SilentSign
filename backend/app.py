...
# 导入新的模型集成模块
from models.wenxin_integration import get_wenxin_integration
...
def sign_to_text():
    ...
    try:
        ...
        # 调用文心4.5模型识别手语
        result = wenxin_integration.recognize_sign(video_data)
...
def text_to_speech():
    ...
    try:
        ...
        # 调用文心4.5 TTS生成语音
        audio_data = wenxin_integration.text_to_speech(text, voice_type)
...
def speech_to_text():
    ...
    try:
        ...
        # 调用文心4.5 ASR识别语音
        text = wenxin_integration.speech_to_text(audio_data)
